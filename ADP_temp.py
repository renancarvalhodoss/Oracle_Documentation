...
# rodar
[Yesterday 07:26] Lucivan Alves Dos Santos
find /rhweb26/temp -size +100000 | xargs -I {} ls -ld {} | sort -n -k 5

[atlanta@root:/]# find /rhweb26/temp -size +200000 | xargs -I {} ls -ld {} | sort -n -k 5
