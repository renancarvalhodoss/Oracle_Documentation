...
proadsv -query
 ...
 CLIENTES 
DROP TABLE SAPSR3.QCMNWAT_GIN_ERS CASCADE CONSTRAINTS;
DROP TABLE SAPSR3.QCM/RDSXESCN/TB CASCADE CONSTRAINTS;
DROP TABLE SAPSR3.QCM/RDSXESCN/TA CASCADE CONSTRAINTS;
